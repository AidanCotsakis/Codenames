		...
		for row in color_grid:
			for sq in row:
				...
				if shown_grid[printY][printX] == 1:
					...
					topleft_text(win, (word_grid[printY][printX]), 20, printX * win_size/5 + sqG + 2 + win_size + offset, printY * win_size/5 + sqG + 2, (255, 255, 255))
				else:
...
while True:
	...
	while True:
		...
		print(yellow_left,blue_left,red_left)
